...
new_playlist_page = page.children.add_new(PageBlock)
new_playlist_page.title = '찐막 JJINMAK'
print("Page 제목은  :", new_playlist_page.title)

import os

files = os.listdir('playlist_txt2/')
...
for filename in files:
    if ".txt" not in filename:
        continue
    file = open('playlist_txt2/' + filename, 'r', encoding='utf-8')
    new_page = new_playlist_page.children.add_new(PageBlock)
